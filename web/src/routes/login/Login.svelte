        ...
        <div class="my-4 grid gap-4 md:grid-cols-2">
            <div>
                <label for="name" class="italic"
                    >Username <span class="text-sm">{'(2-20 characters)'}</span
                    ></label
                >
                <div class="group relative">
                    <input
                        class="bg-fire relative z-10 w-full rounded-xl border-4 border-black p-2 outline-none"
                        id="name"
                        name="name"
                        type="text"
                        maxlength="20"
            ...
            <div>
                <label for="name" class="italic"
                    >Password <span class="text-sm">{'(min 5 characters)'}</span
                    ></label
                >
                <div class="group relative">
                    <input
